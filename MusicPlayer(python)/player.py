...
image_icon = PhotoImage(file="D:\Projects\MusicPlayer(python)\logo png.png")
root.iconphoto(False, image_icon)


frameCnt = 30
frames = [PhotoImage(file='D:\Projects\MusicPlayer(python)\hir.gif',format = 'gif -index %i' %(i)) for i in range(frameCnt)]
